...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_preonic_grid(
    ...
    KC_GRV , _______, _______, _______, _______, _______, KC_P7  , KC_P8  , KC_P9  , KC_PPLS, KC_PAST, KC_DEL,
    KC_PIPE, _______, _______, _______, _______, _______, KC_P4  , KC_P5  , KC_P6  , KC_PMNS, KC_PSLS, _______,
    _______, _______, _______, _______, _______, _______, KC_P1  , KC_P2  , KC_P3  , KC_PEQL, _______, KC_PENT,
