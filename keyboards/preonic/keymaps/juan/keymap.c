...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_preonic_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_EQL , KC_PLUS, KC_LBRC, KC_RBRC, _______,
    _______, _______, _______, _______, _______, _______, _______, KC_MINS, KC_UNDS, KC_LCBR, KC_RCBR, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),
